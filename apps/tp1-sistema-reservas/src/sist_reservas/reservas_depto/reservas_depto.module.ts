...
@Module({
  ...
  imports: [TypeOrmModule.forFeature([ReservasDeptoEntity, DepartamentosEntity]), ClientsModule.register([{ name: 'Mailer_MS', transport: Transport.TCP, options: {port: 3001, host: 'localhost'}}])],
